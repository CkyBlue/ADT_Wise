...
class CommandsBox(BoxLayout):
	### Should anticipate a list of CallableActions objects
	### and generate prompts as necessary
	### Controller should monitor if a prompt is already present
	### and accordingly remove old prompt
	### should thus be able to communicate to the controller object
